    ...
    <section id="gallery" className="py-28 bg-bg-light">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 h-auto md:h-[600px]">
          {/* LEFT — tall */}
          <div data-aos="fade-right" className="relative group rounded-3xl overflow-hidden md:h-full h-72 sm:h-80">
            <Image
              src="/reels/rider.png"
              alt="City Cruising"
              fill
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8">
              ...
              <h3 className="font-montserrat font-black text-2xl sm:text-3xl text-white">Own Every Street</h3>
            </div>
          </div>

          {/* RIGHT — two stacked */}
          <div className="grid grid-rows-2 gap-4 md:gap-6 h-72 sm:h-80 md:h-full">
            <div data-aos="fade-left" data-aos-delay="80" className="relative group rounded-3xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                ...
                <h3 className="font-montserrat font-black text-lg sm:text-xl text-white">Next-Gen Controls</h3>
              </div>
            </div>
            <div data-aos="fade-left" data-aos-delay="160" className="relative group rounded-3xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                ...
                <h3 className="font-montserrat font-black text-lg sm:text-xl text-white">Charge Smarter</h3>
              </div>
            </div>
          </div>
        </div>
