...
const slides = [
  {
    ...
    tagline:
      "India's sharpest electric scooter. Engineered for riders who demand more from every kilometre.",
  ...
  },
  {
    ...
    tagline:
      "Designed for the city that never stops. Lightweight, nimble, and always connected.",
    desc: "Navigate every lane, every signal, every shortcut with the scooter that was built specifically for Indian city roads.",
    features: [
      "Ultra-light alloy frame",
      "Seamless Bluetooth connect",
      "90 km city range",
    ],
    accent: "#3b82f6",
  ...
  },
  {
    ...
    tagline:
      "The future of sustainable mobility — without sacrificing a single kilometre of performance.",
    desc: "Eco+ delivers 140 km of emission-free riding on a single charge. Choose the planet. Keep the speed.",
    features: [
      "140 km max eco range",
      "Regen braking tech",
...
export default function HeroSlider() {
  ...
  return (
    <section className="relative min-h-[100svh] w-full flex flex-col justify-start sm:justify-center overflow-hidden bg-[#080810]">
      ...
      <div className="relative w-full aspect-[16/10] sm:aspect-auto sm:absolute sm:inset-0 sm:h-auto z-0 overflow-hidden mt-20 sm:mt-0">
        {slides.map((s, i) => (
          <div
            key={i}
        ...
        <div className="max-w-6xl w-full mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 lg:gap-10">
          ...
          <div className="text-left w-full lg:max-w-[560px]">
            ...
            >
              {slide.features.map((feat) => (
                <li
                  key={feat}
                  className="flex items-center gap-2.5 text-sm text-white/75 font-medium"
                >
                  <span
            ...
            <div className="hidden sm:flex flex-wrap gap-x-5 gap-y-2 animate-heroFadeUp animation-delay-300">
              {[
                ...
                <span
                  key={t}
                  className="flex items-center gap-1.5 text-[11px] font-semibold text-white/40 uppercase tracking-wider"
                >
          ...
          <div className="flex flex-col items-stretch sm:items-end gap-4 sm:gap-6 w-full lg:w-auto lg:self-end lg:mb-4">
            ...
            >
              {[
                {
                  v: slide.speed.split(" ")[0],
                  u: slide.speed.split(" ")[1],
                  l: "Top Speed",
                },
                {
                  v: slide.range.split(" ")[0],
                  u: slide.range.split(" ")[1],
                  l: "Range",
                },
                {
                  v: slide.battery.split(" ")[0],
                  u: slide.battery.split(" ")[1],
                  l: "Battery",
                },
              ].map((s, i) => (
